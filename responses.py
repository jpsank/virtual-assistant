...
for i in range(num):
    ...
    {"input": [".*answer to life",".*answer to the universe",".*answer to everything"],
     "reply": ["how many roads must a man walk down?","T put conversations below so they don't interfere with utilities and such he Answer to the Great Question... Of Life, the Universe and Everything... Is... Forty-Two","You're really not going to like it"]},
    {"input": [".*meaning of life"],
